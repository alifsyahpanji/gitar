...
<div class="title-materi">Materi Chord Gitar</div>

<div class="center-container">

    <div class="card shadow" style="width: 290px;">
        <img src="../assets/materi/membaca-chord.jpg" class="card-img-top" alt="...">
        <div class="card-body">
            <h5 class="card-title">Cara Membaca Chord</h5>
            <a href="cara-membaca-chord.php" class="btn btn-primary mt-3">Lihat</a>
        </div>
    </div>
